...
from archs import googlenet as g

print('start loading model file...')
caffe_model = CaffeFunction('pretrained_models/bvlc_googlenet.caffemodel')
print('done.')
...
serializers.save_npz('pretrained_models/converted_googlenet.npz', googlenet)
print('done')
